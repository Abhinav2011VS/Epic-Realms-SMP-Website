!(function () {
    ...
    var tt,
        ...
        Yt = function () {
            ...
            Yt = tt
                ...
                : ((e = x("iframe")), (r = "java" + $t + ":"), (e.style.display = "none"), Kt.appendChild(e), (e.src = String(r)), (t = e.contentWindow.document).open(), t.write(Xt("document.F=Object")), t.close(), t.F);
    ...
    var Ne = { IteratorPrototype: Oe, BUGGY_SAFARI_ITERATORS: _e },
        ...
        Ze = function (t, e, r, n, o, i, a) {
            ...
            if (
                (g && ((u = Ue(g.call(new t()))), $e !== Object.prototype && u.next && (Ue(u) !== $e && (Ge ? Ge(u, $e) : "function" != typeof u[He] && T(u, He, Qe)), Be(u, l, !0))),
                o == Ye &&
                    d &&
                    d.name !== Ye &&
                    ((h = !0),
                ...
                if (((s = { values: f(Ye), keys: i ? v : f(Xe), entries: f(Je) }), a)) for (c in s) (Ve || h || !(c in p)) && rt(p, c, s[c]);
    ...
    Ze(
        ...
        function () {
            var t,
                ...
                r = e.string,
                n = e.index;
            return n >= r.length ? { value: void 0, done: !0 } : ((t = tr(r, n)), (e.index += t.length), { value: t, done: !1 });
        }
    );
    ...
    var fr = "[object z]" === String(cr),
        ...
        gr = function (t) {
            var e,
                ...
                h = vr(u),
                p = 0;
            if ((l && (f = re(f, c > 2 ? arguments[2] : void 0, 2)), null == h || (s == Array && ur(h)))) for (r = new s((e = ft(u.length))); e > p; p++) (a = l ? f(u[p], p) : u[p]), sr(r, p, a);
            else for (i = (o = h.call(u)).next, r = new s(); !(n = i.call(o)).done; p++) (a = l ? or(o, f, [n.value, p], !0) : n.value), sr(r, p, a);
            return (r.length = p), r;
        },
        yr = qt("iterator"),
        mr = !1;
                ...
                var o = t(function (t, a) {
                    ...
                    u = function (t, e, r) {
                        ...
                        return (
                            c
                                ? (c.value = r)
                                : ((u.last = c = { index: (o = $r(e, !0)), key: e, value: r, previous: (n = u.last), next: void 0, removed: !1 }),
                                  u.first || (u.first = c),
                                  n && (n.next = c),
                                  i ? u.size++ : t.size++,
                                  "F" !== o && (u.index[o] = c)),
    ...
    Lt({ target: "Map", proto: !0, real: !0, forced: q }, { upsert: pn }), Lt({ target: "Map", proto: !0, real: !0, forced: q }, { updateOrInsert: pn });
    var dn = "\t\n\v\f\r                　\u2028\u2029\ufeff",
        vn = "[" + dn + "]",
        gn = RegExp("^" + vn + vn + "*"),
        yn = RegExp(vn + vn + "*$"),
    ...
    if (Tt(An, !On(" 0o1") || !On("0b1") || On("+0x1"))) {
        for (
            var In,
                ...
                kn = i ? wn(On) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","),
                Ln = 0;
            kn.length > Ln;
            Ln++
        )
    ...
    var ji = xi;
    Lt({ target: "RegExp", proto: !0, forced: /./.exec !== ji }, { exec: ji }), i && ("g" != /./g.flags || ni.UNSUPPORTED_Y) && I.f(RegExp.prototype, "flags", { configurable: !0, get: Zo });
    var Pi = et.get,
        Ii = RegExp.prototype;
    i &&
        ni.UNSUPPORTED_Y &&
            ...
            if (!a || !u || ("replace" === t && (!_i || !Ni || Fi)) || ("split" === t && !Bi)) {
                var s = /./[i],
                    c = r(
                        ...
                        ""[t],
                        function (t, e, r, n, o) {
                            return e.exec === ji ? (a && !o ? { done: !0, value: s.call(e, r, n) } : { done: !0, value: t.call(r, e, n) }) : { done: !1 };
                        },
                    ...
                    "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                        ? function (t, r) {
                              ...
                              for (
                                  ...
                                  (i = ji.call(f, n)) && !((a = f.lastIndex) > c && (s.push(n.slice(c, i.index)), i.length > 1 && i.index < n.length && Xi.apply(s, i.slice(1)), (u = i[0].length), (c = a), s.length >= o));
    ...
    var va = wt.f,
        ...
        $a = function (t, e, r) {
            t === Ia && $a(Ca, e, r), j(t);
            var n = m(e, !0);
            return j(r), w(Na, n) ? (r.enumerable ? (w(t, xa) && t[xa][n] && (t[xa][n] = !1), (r = Jt(r, { enumerable: f(0, !1) }))) : (w(t, xa) || Ua(t, xa, f(1, {})), (t[xa][n] = !0)), Wa(t, n, r)) : Ua(t, n, r);
        },
        Va = function (t, e) {
            j(t);
            var r = g(e),
                    ...
                    fetch: function (t) {
                        ...
                        return (
                            arguments.length > 1 &&
                                (y((e = arguments[1])) &&
                                    pr((r = e.body)) === es &&
                                    ((n = e.headers ? new Zu(e.headers) : new Zu()).has("content-type") || n.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"), (e = Jt(e, { body: f(0, String(r)), headers: f(0, n) }))),
                                o.push(e)),
                            Qu.apply(this, o)
                        );
                    },
    ...
    var Ss,
        ...
        Ic = function (t, e, r, n) {
            var o,
                ...
                d = !1;
            for (
                r || ((t.scheme = ""), (t.username = ""), (t.password = ""), (t.host = null), (t.port = null), (t.path = []), (t.query = null), (t.fragment = null), (t.cannotBeABaseURL = !1), (e = e.replace(Ws, ""))),
                    e = e.replace(Ks, ""),
                    o = gr(e);
                f <= o.length;
                        ...
                        if (i == Ss || "/" == i || ("\\" == i && ec(t)) || (!r && ("?" == i || "#" == i))) {
                            if (
                                (".." === (s = (s = l).toLowerCase()) || "%2e." === s || ".%2e" === s || "%2e%2e" === s
                                    ...
                                    : ("file" == t.scheme && !t.path.length && oc(l) && (t.host && (t.host = ""), (l = l.charAt(0) + ":")), t.path.push(l)),
                                (l = ""),
        ...
        Lc = function () {
            var t = Ps(this),
                ...
                c = e + ":";
            return (
                null !== o ? ((c += "//"), rc(t) && (c += r + (n ? ":" + n : "") + "@"), (c += Hs(o)), null !== i && (c += ":" + i)) : "file" == e && (c += "//"),
    ...
    var If,
        ...
        ol = function (t, e, r) {
            var o, i;
            Qf ? (((o = $f.createEvent("Event")).promise = e), (o.reason = r), o.initEvent(t, !1, !0), n.dispatchEvent(o)) : (o = { promise: e, reason: r }),
                (i = n["on" + t])
                    ? i(o)
                    : t === Zf &&
                      (function (t, e) {
    ...
    if (wl)
        var Sl = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"],
            El =
                ArrayBuffer.isView ||
                function (t) {
                ...
                (this._bodyInit = t),
                    ...
                    this.headers.get("content-type") ||
                        ("string" == typeof t
                            ...
                            : gl && URLSearchParams.prototype.isPrototypeOf(t) && this.headers.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"));
            }),
            ml &&
                ((this.blob = function () {
                    var t = jl(this);
