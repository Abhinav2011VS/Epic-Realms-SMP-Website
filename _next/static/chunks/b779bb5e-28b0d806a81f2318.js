    ...
    [5417],
    {
        37243: function (e, t, n) {
            ...
            class $ {
                ...
                get commands() {
                    return this.extensions.reduce((e, t) => {
                        let n = { name: t.name, options: t.options, storage: t.storage, editor: this.editor, type: S(t.name, this.schema) },
                            r = h(t, "addCommands", n);
                        return r ? { ...e, ...r() } : e;
                    }, {});
                }
                get plugins() {
                    let { editor: e } = this,
                        t = $.sort([...this.extensions].reverse()),
                        n = [],
                        o = [],
                        s = t
                            .map((t) => {
                                let r = { name: t.name, options: t.options, storage: t.storage, editor: e, type: S(t.name, this.schema) },
                                    s = [],
                                ...
                                E(t, e.options.enableInputRules) && c && n.push(...c());
                        ...
                        (function (e) {
                            let { editor: t, rules: n } = e,
                                o = new r.Sy({
                                            ...
                                            return (
                                                s &&
                                                    setTimeout(() => {
                                                        let { from: e, text: r } = s,
                                                            i = e + r.length;
                                                        A({ editor: t, from: e, to: i, text: r, rules: n, plugin: o });
                                                    }),
                                    ...
                                    props: {
                                        handleTextInput: (e, r, i, s) => A({ editor: t, from: r, to: i, text: s, rules: n, plugin: o }),
                                        handleDOMEvents: {
                                            compositionend: (e) => (
                                                setTimeout(() => {
                                        ...
                                        (function (e) {
                                            ...
                                            return (
                                                n.doc.nodesBetween(r, o, (e, t) => {
                                                    ...
                                                    B(e.textBetween(u - t, h - t, void 0, "￼"), i.find, s).forEach((e) => {
                                    ...
                                    new r.Sy({
                                        ...
                                        appendTransaction: (t, n, r) => {
                                            ...
                                            if (p) {
                                                let { from: t, text: n } = u,
                                                    o = t + n.length;
                                                return d({ rule: e, state: r, from: t, to: { b: o }, pasteEvt: j(n) });
                                            }
                                            let h = n.doc.content.findDiffStart(r.doc.content),
                                                f = n.doc.content.findDiffEnd(r.doc.content);
                                            if ("number" == typeof h && f && h !== f.b) return d({ rule: e, state: r, from: h, to: f, pasteEvt: a });
                                        },
                                    })
                            );
                        })({ editor: e, rules: o }),
                ...
                setupExtensions() {
                    this.extensions.forEach((e) => {
                        ...
                        let n = { name: e.name, options: e.options, storage: e.storage, editor: this.editor, type: S(e.name, this.schema) };
                ...
                return (
                    D(e) &&
                        ...
                        Object.keys(t).forEach((r) => {
                            D(t[r]) && r in e ? (n[r] = I(e[r], t[r])) : Object.assign(n, { [r]: t[r] });
                        }),
                    n
                );
            }
            class R {
                ...
                configure(e = {}) {
                    let t = this.extend();
                    return (t.parent = this.parent), (t.options = I(this.options, e)), (t.storage = k(h(t, "addStorage", { name: t.name, options: t.options }))), t;
                }
                extend(e = {}) {
                    let t = new R({ ...this.config, ...e });
                    return (
                        (t.parent = this),
                        (this.child = t),
                            ...
                            props: {
                                clipboardTextSerializer: () => {
                                    let { editor: e } = this,
                                        ...
                                        l = L(n);
                                    return z(r, { from: s, to: a }, { ...(void 0 !== this.options.blockSeparator ? { blockSeparator: this.options.blockSeparator } : {}), textSerializers: l });
                                },
                            },
                        }),
                    ];
            ...
            let Y = (e) => {
                ...
                for (let n = t.length - 1; n >= 0; n -= 1) {
                    let r = t[n];
                    3 === r.nodeType && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? e.removeChild(r) : 1 === r.nodeType && Y(r);
                }
                return e;
            };
            function _(e) {
                let t = `<body>${e}</body>`;
                return Y(new window.DOMParser().parseFromString(t, "text/html").body);
            }
            function X(e, t, n) {
            ...
            function ee(e, t, n = {}) {
                ...
                let l = o - r,
                    d = a.filter((e) => !s || s.name === e.node.type.name).filter((e) => F(e.node.attrs, n, { strict: !1 }));
            ...
            function er(e, t, n = {}) {
                return X(e, t, { slice: !1, parseOptions: n });
            }
            function eo(e, t) {
                let n = q(t, e.schema),
            ...
            function ep(e, t) {
                let n = eu(t);
                return ec(s.NB.fromJSON(n, e).content, n);
            }
            function eh(e, t) {
            ...
            function ef(e, t, n) {
                let { blockSeparator: r = "\n\n", textSerializers: o = {} } = n || {},
                    i = eu(t);
                return eh(s.NB.fromJSON(i, e), { blockSeparator: r, textSerializers: { ...L(i), ...o } });
            }
            function em(e, t) {
            ...
            function eb(e, t, n = {}) {
                ...
                if (r) return !!(e.storedMarks || e.selection.$from.marks()).filter((e) => !i || i.name === e.type.name).find((e) => F(e.attrs, n, { strict: !1 }));
                let s = 0,
                    a = [];
                if (
                ...
                let l = a
                        ...
                        .filter((e) => F(e.mark.attrs, n, { strict: !1 }))
            ...
            var eC = Object.freeze({
                ...
                focus: (e = null, t = {}) => ({ editor: n, view: r, tr: o, dispatch: i }) => {
                    ...
                    if (i && null === e && !J(n.state.selection)) return s(), !0;
                    let a = U(o.doc, e) || n.state.selection,
                ...
                insertContentAt: (e, t, n) => ({ tr: o, dispatch: i, editor: s }) => {
                    if (i) {
                        let i;
                        n = { parseOptions: {}, updateSelection: !0, applyInputRules: !1, applyPasteRules: !1, ...n };
                        let l = X(t, s.schema, { parseOptions: { preserveWhitespace: "full", ...n.parseOptions } });
                        if ("<>" === l.toString()) return !0;
                        let { from: d, to: c } = "number" == typeof e ? { from: e, to: e } : { from: e.from, to: e.to },
                            u = !0,
                            p = !0;
                        if (
                            ((Q(l) ? l : [l]).forEach((e) => {
                            ...
                            let { parent: e } = o.doc.resolve(d);
                            !e.isTextblock || e.type.spec.code || e.childCount || ((d -= 1), (c += 1));
                        }
                        u ? ((i = Array.isArray(t) ? t.map((e) => e.text || "").join("") : "object" == typeof t && t && t.text ? t.text : t), o.insertText(i, d, c)) : ((i = l), o.replaceWith(d, c, i)),
                            n.updateSelection &&
                                (function (e, t, n) {
                            ...
                            n.applyInputRules && o.setMeta("applyInputRules", { from: d, text: i }),
                            n.applyPasteRules && o.setMeta("applyPasteRules", { from: d, text: i });
                    }
                    return !0;
                },
                ...
                keyboardShortcut: (e) => ({ editor: t, view: n, tr: r, dispatch: o }) => {
                    let i = (function (e) {
                            ...
                            for (let e = 0; e < i.length - 1; e += 1) {
                                ...
                                else if (/^mod$/i.test(s)) G() || Z() ? (o = !0) : (n = !0);
                ...
                setNode: (e, t = {}) => ({ state: n, dispatch: r, chain: o }) => {
                    ...
                    return i.isTextblock
                        ? o()
                              .command(({ commands: e }) => !!(0, l.uJ)(i, t)(n) || e.clearNodes())
                              .command(({ state: e }) => (0, l.uJ)(i, t)(e, r))
                              .run()
                ...
                splitBlock: ({ keepMarks: e = !0 } = {}) => ({ tr: t, state: n, dispatch: o, editor: i }) => {
                    let { selection: s, doc: l } = t,
                        { $from: d, $to: c } = s,
                        u = ev(i.extensionManager.attributes, d.node().type.name, d.node().attrs);
                    if (s instanceof r.qv && s.node.isBlock) return !!(d.parentOffset && (0, a.Ax)(l, d.pos)) && (o && (e && eS(n, i.extensionManager.splittableMarks), t.split(d.pos).scrollIntoView()), !0);
                ...
                toggleList: (e, t, n, r = {}) => ({ editor: o, tr: i, state: s, dispatch: a, chain: l, commands: d, can: c }) => {
                    ...
                    if (k.depth >= 1 && x && k.depth - x.depth <= 1) {
                        ...
                        if (ek(x.node.type.name, u) && h.validContent(x.node.content) && a)
                            return l()
                ...
                toggleMark: (e, t = {}, n = {}) => ({ state: r, commands: o }) => {
                    let { extendEmptyMarkRange: i = !1 } = n,
                        s = q(e, r.schema);
                    return eb(r, s, t) ? o.unsetMark(s, { extendEmptyMarkRange: i }) : o.setMark(s, t);
                },
            ...
            let eT = R.create({ name: "commands", addCommands: () => ({ ...eC }) }),
                eP = R.create({
                    name: "editable",
                    addProseMirrorPlugins() {
                                    ...
                                    () =>
                                        e.command(({ tr: t }) => {
                                            let { selection: n, doc: o } = t,
                                                ...
                                                p = c && 1 === d.parent.childCount ? u === s.pos : r.Y1.atStart(o).from === a;
            ...
            class ej {
                ...
                get parent() {
                    ...
                    return new ej(this.resolvedPos.doc.resolve(e), this.editor);
                }
                get before() {
                    let e = this.resolvedPos.doc.resolve(this.from - (this.isBlock ? 1 : 2));
                    return e.depth !== this.depth && (e = this.resolvedPos.doc.resolve(this.from - 3)), new ej(e, this.editor);
                }
                get after() {
                    let e = this.resolvedPos.doc.resolve(this.to + (this.isBlock ? 2 : 1));
                    return e.depth !== this.depth && (e = this.resolvedPos.doc.resolve(this.to + 3)), new ej(e, this.editor);
                }
                get children() {
                    let e = [];
                    return (
                        this.node.content.forEach((t, n) => {
                            ...
                            let s = new ej(i, this.editor, r, r ? t : null);
                            r && (s.actualDepth = this.depth + 1), e.push(new ej(i, this.editor, r, r ? t : null));
                        }),
                        e
                    );
                }
...
.tippy-box[data-animation=fade][data-state=hidden] {
  opacity: 0
            ...
            class eD extends p {
                ...
                createExtensionManager() {
                    ...
                    let n = [
                        ...(this.options.enableCoreExtensions
                            ? [
                                  eP,
                                  H.configure({ blockSeparator: null === (t = null === (e = this.options.coreExtensionOptions) || void 0 === e ? void 0 : e.clipboardTextSerializer) || void 0 === t ? void 0 : t.blockSeparator }),
                                  eT,
                                  eA,
                                  eN,
                                  eB,
                ...
                createView() {
                    let e = er(this.options.content, this.schema, this.options.parseOptions),
                        t = U(e, this.options.autofocus);
                    this.view = new o.tk(this.options.element, { ...this.options.editorProps, dispatchTransaction: this.dispatchTransaction.bind(this), state: r.yy.create({ doc: e, selection: t || void 0 }) });
                ...
                getText(e) {
                    ...
                    return eh(this.state.doc, { blockSeparator: t, textSerializers: { ...L(this.schema), ...n } });
                }
                get isEmpty() {
                ...
                $pos(e) {
                    return new ej(this.state.doc.resolve(e), this);
                }
                get $doc() {
                    return this.$pos(0);
                }
            ...
            class eH {
                ...
                configure(e = {}) {
                    let t = this.extend();
                    return (t.options = I(this.options, e)), (t.storage = k(h(t, "addStorage", { name: t.name, options: t.options }))), t;
                }
                extend(e = {}) {
            ...
            class eV {
                ...
                onDragStart(e) {
                    ...
                    let f = r.qv.create(d.state.doc, this.getPos()),
                            ...
                            : !!this.node.isLeaf ||
                              ...
                              (!(
                                  ...
                                  (this.dom.contains(e.target) &&
                                      "childList" === e.type &&
                                      (G() || "Android" === navigator.platform || /android/i.test(navigator.userAgent)) &&
